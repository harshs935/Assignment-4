...
int main() {
    ...
    trafficDepartment.readAndStore("A4-Q1.csv");

    int choice;
    do {
        cout << "\nTraffic Department Menu:\n";
        cout << "1. Display all vehicles\n";
        cout << "2. Add a new vehicle\n";
        cout << "3. Delete a vehicle\n";
        cout << "4. Edit vehicle information\n";
        cout << "0. Exit\n";
        ...
        switch (choice) {
            case 1:
                cout << "All Vehicles:\n";
                trafficDepartment.displayAllVehicles();
                break;
            case 2:
                trafficDepartment.userInput();
                break;
            case 3: {
                string delete_vehicle_number;
                cout << "Enter the vehicle number to delete: ";
                cin >> delete_vehicle_number;
                trafficDepartment.deleteVehicle(delete_vehicle_number);
                break;
            }
            case 4: {
                string edit_vehicle_number, new_name, new_gender, new_address;
                int new_age;
                cout << "Enter the vehicle number to edit: ";
                cin >> edit_vehicle_number;
                ...
                cout << "New Owner Age: ";
                cin >> new_age;
                cout << "New Owner Gender: ";
                cin.ignore();
                getline(cin, new_gender);
                cout << "New Owner Address: ";
                cin.ignore();
                getline(cin, new_address);
                trafficDepartment.editVehicleInfo(edit_vehicle_number, new_name, new_age, new_gender, new_address);
                break;
            }
            case 0:
    ...
    trafficPolice.readAndStoreViolations("A4-Q2.csv");

    int choice2;
    do {
        cout << "\nTraffic Police Menu:\n";
        cout << "1. Display all traffic violations\n";
        cout << "2. Add a new violation\n";
        cout << "3. Delete a violation\n";
        cout << "4. Edit violation information\n";
        cout << "0. Exit\n";
        cout << "Enter your choice: ";
        cin >> choice2;
        ...
        switch (choice2) {
            case 1:
                cout << "All Traffic Violations:\n";
                trafficPolice.displayAllViolations();
                break;
            case 2:
                trafficPolice.userInput();
                break;
            case 3: {
                string delete_vehicle_number;
                cout << "Enter the vehicle number to delete: ";
                cin >> delete_vehicle_number;
                trafficPolice.deleteViolation(delete_vehicle_number);
                break;
            }
            case 4: {
                string edit_vehicle_number, new_type, new_location;
                cout << "Enter the vehicle number to edit: ";
                cin >> edit_vehicle_number;
                cout << "Enter new information:\n";
                cout << "New Violation Type: ";
                cin.ignore();
                getline(cin, new_type);
                cout << "New Location: ";
                getline(cin, new_location);
                trafficPolice.editViolation(edit_vehicle_number, new_type, new_location);
                break;
            }
            case 0:
                cout << "Exiting the Traffic Police menu.\n";
                break;
            default:
                cout << "Invalid choice. Please enter a valid option.\n";
        }
